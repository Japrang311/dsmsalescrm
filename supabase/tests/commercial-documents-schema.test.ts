...
const EXPECTED_TABLES: Record<string, ExpectedTable> = {
  commercial_documents: {
    ...
    columns: {
      ...
      source_rfq_document_id: { dataType: "uuid", nullable: true },
      quotation_expired_date: { dataType: "date", nullable: true },
      ...
      lost_reason: { dataType: "text", nullable: true },
      lost_reason_detail: { dataType: "text", nullable: true },
  ...
  sales_orders: {
    ...
    columns: {
      ...
      customer_po_date: { dataType: "date", nullable: true },
