...
### Accepted Super Admin rules (Phase 12)

See the `commercial-and-admin-rules` skill for the full accepted rules — load it before touching roles, RLS, Settings, auth, or commercial schema.
